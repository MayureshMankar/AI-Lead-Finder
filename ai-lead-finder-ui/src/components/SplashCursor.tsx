...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Add type for pointerPrototype
    function pointerPrototype(this: any) {
      this.id = -1 as number;
      this.texcoordX = 0 as number;
      this.texcoordY = 0 as number;
      this.prevTexcoordX = 0 as number;
      this.prevTexcoordY = 0 as number;
      this.deltaX = 0 as number;
      this.deltaY = 0 as number;
      this.down = false as boolean;
      this.moved = false as boolean;
      this.color = [0, 0, 0] as [number, number, number];
    }
    ...
    function updatePointerMoveData(pointer: any, posX: number, posY: number, color: RGBColor) {
      pointer.prevTexcoordX = pointer.texcoordX;
      pointer.prevTexcoordY = pointer.texcoordY;
      pointer.texcoordX = posX / canvas.width;
      pointer.texcoordY = 1.0 - posY / canvas.height;
